...
function LandingPage() {
  return (
    <>
      <Head>
        <title>SubM - Subscription Management Platform</title>
      </Head>
            ...
            <div className="flex flex-col gap-12">
              <div>
                ...
                <h2 className="text-2xl font-bold text-gray-400">
                  SubM provides a Platform for your business to grow, with the right analytics to make sure the business always stays on the
                  right path.
                </h2>
              </div>
            ...
            <CardContent className="w-full">
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-5">
                  ...
                  <AccordionContent>
                    You are not allowed to delete products or tiers as it will disrupt users who are using those products, contact us if any
                    issues arise.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
